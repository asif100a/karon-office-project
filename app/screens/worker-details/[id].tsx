...
export default function WorkerDetailsScreen() {
  ...
  const worker = id ? WORKER_DETAILS[id] : undefined;
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#F8FAFC" }} edges={["top"]}>
      ...
      {showEmptyState ? (
        <View className="flex-1 items-center justify-center px-6">
          <View className="w-24 h-24 rounded-full bg-orange-50 items-center justify-center mb-5">
          ...
          <Text className="text-neutral-500 text-sm text-center mt-3 leading-6 max-w-[260px]">
        ...
        <>
            ...
            <View className="px-4 pt-6 pb-28">
              <View className="items-center">
                <View className="relative">
                  ...
                  />
                  <View className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-emerald-50 border border-emerald-300 px-3 py-1 rounded-full">
          ...
          <View className="absolute bottom-0 left-0 right-0 bg-white border-t border-neutral-100 px-4 py-4 flex-row gap-3">
            ...
            <TouchableOpacity className="flex-1 py-4 border border-neutral-200 rounded-2xl items-center justify-center bg-white active:opacity-75">

...
export default function CancelledJobDetailScreen() {
  ...
  const jobDetails = {
    ...
    policyText:
      "You will be charged 50% of the job fee as you cancelled after the 48 window.",
    ...
    <ScreenWrapper>
      ...
      >
        <View className="px-5 pt-4 pb-12">
          {/* Job Details */}
          <View className="bg-white rounded-xl p-5 border border-neutral-200/80 mb-4">
            <View className="flex-row justify-between items-start mb-4">
              ...
              <View className="items-end">
                <View className="px-2.5 py-1 rounded-lg bg-orange-50">
                  <Text className="text-[10px] font-extrabold text-orange-500">
          ...
          {/* Policy */}
          <View className="bg-orange-50 border border-orange-200/80 rounded-xl px-4 py-4 flex-row items-start gap-3 mb-4">
          ...
          {/* Cancelled */}
          <View className="bg-white rounded-2xl p-6 border border-neutral-200/80 items-center mb-4">
            <View className="w-12 h-12 bg-red-50 rounded-full items-center justify-center mb-4 border border-red-100">
              <ShieldAlert size={24} color="#DC2626" />
            </View>
            <Text className="text-neutral-900 font-extrabold text-xl mb-2">
